                ...
                <div class="single-post">
                        ...
                        <ul class="comment-list">
                            ...
                            <li>
                                ...
                                <div class="commetn-text">
                                    <h3>{{$item->user->name}} | {{$article->created_at->format('d')}}
                                        {{\Illuminate\Support\Str::limit(date('F',strtotime($article->created_at)), 3, $end='')}},
                                        {{$article->created_at->format('Y')}} |
                                        {{$article->created_at->format('H')}}H{{$article->created_at->format('i')}}</h3>
                                    <p>{{$item->comment}}</p>
                                </div>
                            </li>
                            @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-9 comment-from">
                            ...
                            <form action="{{route('saveComment', $article->id)}}" method="post" class="form-class">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
